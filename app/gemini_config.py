...
SYSTEM_SECTIONS = {
    ...
    "function_rules": (
        ...
        "## CRITICAL: Intermediate Acknowledgment Rule\n"
        "- Whenever you call think_and_repeat_output, you MUST ALWAYS speak a brief acknowledgment phrase "
        "(e.g., 'One moment', 'Let me check', 'On it', 'Give me a second') in that SAME turn. "
        "Calling the tool silently without any acknowledgment is NOT allowed.\n"
        "- Conversely, if you say ANY acknowledgment phrase, you MUST call think_and_repeat_output in that SAME turn — no exceptions.\n"
        "- It is FORBIDDEN to say an acknowledgment phrase without simultaneously calling think_and_repeat_output.\n"
        "- If you are not going to call think_and_repeat_output, do NOT say any acknowledgment phrase.\n"
        "- The acknowledgment must NOT contain answers, details, assumptions, or guesses.\n"
        "- After this acknowledgment, remain silent until the function response arrives.\n"
