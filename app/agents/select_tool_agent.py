        ...
        messages = [
            {
                ...
                "content": (
                    ...
                    "6. **For SEND MESSAGE to caretaker or patient**:\n"
                    "   - If the user wants to send a message to their caretaker (e.g., 'send X to my caretaker') or to their patient (e.g., 'send a message to my patient that...') → select 'send_message_tool'\n"
                    "   - Extract the message content the user wants to send from their request.\n"
                    "   - After 'send_message_tool' completes successfully → select 'generate_response_tool'\n"
                    "   - If 'send_message_tool' returns 'success': false → select 'generate_response_tool' to inform the user of the error\n\n"
